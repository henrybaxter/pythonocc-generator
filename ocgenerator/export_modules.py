...
EXPORT_MODULES = {
    'OC': {v[0]: v[:1] for v in [
        ...
        ('ShapeCustom',
            ['BRep', 'Message', 'Poly', 'TShort',
             'Bnd', 'TColGeom', 'ShapeExtend', ],
